...
Route::prefix('admin')
    ...
    ->group(function () {
        ...
        Route::get('/RevenueDetail', [DashboardController::class, 'RevenueDetail'])->name('dashboard.RevenueDetail');
        Route::get('/OrderDetail', [DashboardController::class, 'OrderDetail'])->name('dashboard.OrderDetail');
        Route::get('/UserDetail', [DashboardController::class, 'UserDetail'])->name('dashboard.UserDetail');
        Route::get('/ProductSoldDetail', [DashboardController::class, 'ProductSoldDetail'])->name('dashboard.ProductSoldDetail');
        //BRAND
        Route::prefix('brands')
            ->as('brands.')
            ->group(function () {
        ...
        Route::prefix('permissions')
            ...
            Route::post('/toggle-status', [PermissionController::class, 'toggleStatus'])->name('toggleStatus');
        });
        //ROLES
        Route::prefix('roles')
            ->as('roles.')
        ...
        Route::prefix('users')
            ...
            // Route for fetching districts based on selected province
            Route::get('get-districts/{province_code}', [UserController::class, 'getDistricts'])->name('get.districts');

            // Route for fetching wards based on selected district
            Route::get('get-wards/{district_code}', [UserController::class, 'getWards'])->name('get.wards');
        });
