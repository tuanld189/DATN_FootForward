...
//     if ($order && $order->status_order != 'canceled') {
//         $order->status_order = 'canceled';
//         $order->canceled_at = now(); // If you have a column for canceled timestamp
//         $order->save();

//         return redirect()->back()->with('status', 'Order has been canceled successfully.');
//     }

//     return redirect()->back()->with('error', 'Order could not be canceled.');
// }
