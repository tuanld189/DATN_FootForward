                                ...
                                <div class="d-flex align-items-end justify-content-between mt-4">
                                    <div>
                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4">
                                            {{ number_format($totalRevenue, 0, ',', '.') }}VNĐ</h4>
                        ...
                        <div class="card card-animate">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-end justify-content-between mt-4">
                                    <div>
                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4">
                                            {{ number_format($totalOrders, 0, ',', '.') }}</h4>
                                        <a href="" class="text-decoration-underline">Xem chi tiết</a>
                                    </div>
                                    <div class="avatar-sm flex-shrink-0">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    {{-- <div class="flex-shrink-0">
                                        <h5 class="text-primary fs-14 mb-0">
                                            <i class="ri-user-line fs-13 align-middle"></i> +10.00 %
                                        </h5>
                                    </div> --}}
                                </div>
                                <div class="d-flex align-items-end justify-content-between mt-4">
                                    <div>
                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4">
                                            {{ number_format($totalCustomers, 0, ',', '.') }}</h4>
                                        <a href="" class="text-decoration-underline">Xem chi tiết</a>
                                    </div>
                                    <div class="avatar-sm flex-shrink-0">
                    ...
                    <div class="col-xl-3 col-md-6">
                        ...
                        <div class="card card-animate">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="flex-grow-1 overflow-hidden">
                                        <p class="text-uppercase fw-medium text-muted text-truncate mb-0">Tổng sản phẩm đã bán</p>
                                    </div>
                                    {{-- <div class="flex-shrink-0">
                                ...
                                <div class="row g-0 text-center">
                                    <div class="col-6 col-sm-3">
                                        <div class="p-3 border border-dashed border-start-0">
                                            <h5 class="mb-1">{{ number_format($totalOrders, 0, ',', '.') }}</h5>
                                    ...
                                    <div class="col-6 col-sm-3">
                                        <div class="p-3 border border-dashed border-start-0">
                                            <h5 class="mb-1">{{ number_format($totalRevenue, 0, ',', '.') }}VNĐ</h5>
                                    ...
                                    <div class="col-6 col-sm-3">
                                        <div class="p-3 border border-dashed border-start-0">
                                            {{-- <h5 class="mb-1">{{ number_format($totalCancellations, 0, ',', '.') }}</h5> --}}
                                            <p class="text-muted mb-0">HỦY ĐƠN</p>
                                        </div>
                                    </div>
                                    <!--end col-->
                                </div>
                    ...
                    <div class="col-xl-4">
                        ...
                        <div class="card card-height-100">
                            <div class="card-header align-items-center d-flex">
                                <h4 class="card-title mb-0 flex-grow-1">Địa điểm mua nhiều</h4>
                                <div class="flex-shrink-0">
                                    <button type="button" class="btn btn-soft-primary btn-sm">
                                        Export Report
                                    </button>
