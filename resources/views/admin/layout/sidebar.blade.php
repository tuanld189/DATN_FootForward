                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse menu-dropdown" id="sidebarCategories">
                            <ul class="nav nav-sm flex-column">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('admin.permissions.index') }}" target="_blank" class="nav-link" data-key="t-horizontal">Permissions</a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('admin.roles.index') }}" target="_blank" class="nav-link" data-key="t-horizontal">Roles</a>
                                </li>
                            </ul>
                        </div>
                    </li> <!-- end Dashboard Menu -->
