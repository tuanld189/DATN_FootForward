                                ...
                                <div class=" col-md-7">
                                    ...
                                    <div class="rpw">
                                        <div class="mt-3">
                                            ...
                                            <textarea class="form-control" placeholder="Enter short content............................." id="content"
                                                name="content" rows="3"></textarea>
                                        </div>
                                        <div class="mt-3">
                                            <label for="description" class="form-label">Description:</label>
                                            <textarea class="form-control" placeholder="Enter description............................." id="ckeditor-classic"
                                            ...
                                            @foreach ($sizes as $sizeID => $sizeName)
                                                @foreach ($colors as $colorID => $colorName)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div
                                                                style="width: 50px; height: 50px; background: {{ $colorName }}; border: 1px solid gray; text-align: center;">
                                                            </div>
                                                        </td>
                                                        <td>
                                ...
                                <div class="row gy-4">
                                    <div class="col-md-12">
                                        <div>
                                            ...
                                            <select class="form-control tags-select2" id="tags" name="tags[]"
                                                multiple>
