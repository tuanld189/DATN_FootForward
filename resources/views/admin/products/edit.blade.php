        ...
        <div class="row">
            <div class="col-md-6">
                <div class="mb-3 mt-3">
                    ...
                    <select name="category_id" id="category_id">
                        ...
                        @foreach ($categories as $id => $value)
                            <option @if ($model->category_id == $id) selected @endif value="{{ $id }}">
                                {{ $value }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="mb-3 mt-3">
                    ...
                    <select name="brand_id" id="brand_id">
                        ...
                        @foreach ($brands as $id => $value)
                            <option @if ($model->brand_id == $id) selected @endif value="{{ $id }}">
                                {{ $value }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="mb-3 mt-3">
                    ...
                    <input type="text" class="form-control" id="sku" value="{{ $model->sku }}"
                ...
                <div class="mb-3 mt-3">
                    <label class="form-check-label">
                        <input class="form-check-input" type="checkbox" value="1"
                            @if ($model->status) checked @endif checked name="status"> Status
                    </label>
                </div>
                <div class="mb-3 mt-3">
                    <label class="form-check-label">
                        <input class="form-check-input" type="checkbox" value="1"
                            @if ($model->is_hot_deal) checked @endif checked name="is_hot_deal"> Hot_Deal
                    </label>
                </div>
                <div class="mb-3 mt-3">
                    <label class="form-check-label">
                        <input class="form-check-input" type="checkbox" value="1"
                            @if ($model->is_new) checked @endif checked name="is_new"> New
                    </label>
                </div>
                <div class="mb-3 mt-3">
                    <label class="form-check-label">
                        <input class="form-check-input" type="checkbox" value="1"
                            @if ($model->is_show_home) checked @endif checked name="is_show_home"> Show_Home
                    </label>
                </div>
            </div>
        </div>
