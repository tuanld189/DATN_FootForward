...
<h3 style="font-weight: bold; font-size:40px;font-family: Times New Roman, serif;"> <img src="{{ asset('images/pin1.png') }}" width="40px" alt="Your Image"> @yield('title')</h3>
    ...
    <form action="{{route('admin.product-clusters.store')}}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                <div class="card-header d-flex align-items-center">
                    <h5 class="card-title mb-0 mr-3">Cluster Name:</h5>
                    <input type="text" class="form-control mr-3 ml-3" id="name" placeholder="Enter name" name="name" style="flex-grow: 1;">
                    <button type="submit" class="btn btn-primary mr-1 ml-1" style="width: 100px;">Submit</button>
