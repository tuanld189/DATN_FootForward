...
<style>
    ...
    .signup-container .btn-primary, .signup-container .btn-link {
    ...
    .signup-container .btn-primary:hover, .signup-container .btn-link:hover {
...
<div class="signup-container" >
    ...
    <form action="" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="username" name="fullname" placeholder="Vui lòng nhập họ và tên">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="password" class="form-control" id="confirm-password" name="password_confirmation" placeholder="Xác nhận lại mật khẩu">
        </div>
