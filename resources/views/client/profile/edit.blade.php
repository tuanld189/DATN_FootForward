...
<div class="tab-content border border-top-0 p-4 rounded shadow-lg pb-4" style="margin: 30px 10px;" id="nav-tabContent">
    ...
    <div class="tab-pane fade " id="nav-order" role="tabpanel" aria-labelledby="nav-order-tab">
        ...
        <table class="order-table ">
                ...
                <tbody>
                    <tr>
                        <td>3</td>
                        <td>16-07-2024 07:25</td>
                        <td>Nguyễn Văn Trường</td>
                        <td>01092003</td>
                        <td>3.044.000</td>
                        <td class="status unpaid">ĐANG GIAO</td>
                        <td><button class="btn btn-danger" id="openPopupBtn">Chi tiết</button></td>
                    </tr>
                    <tr>
                        <td>2</td>
                        <td>16-07-2024 07:25</td>
                        ...
                        <td>0339854605</td>
                        <td>3.345.000</td>
                        <td class="status unpaid">ĐÃ GIAO</td>
                        <td><button class="btn btn-danger" id="openPopupBtn">Chi tiết</button></td>
                    </tr>
                    <tr>
                        <td>1</td>
                        ...
                        <td>0222222222</td>
                        <td>399.999</td>
                        <td class="status unpaid">ĐÃ XÁC NHẬN</td>
                        <td><button class="btn btn-danger" id="openPopupBtn">Chi tiết</button></td>
                    </tr>
                </tbody>
            </table>
                ...
                <div class="popup-content">
                    ...
                    <div class="row mb-2">
                        <div class="col-md-6">
                            ...
                            <p><strong> Số sản phẩm:</strong> 2</p>
                            <p><strong> Tên sản phẩm:</strong> Nike Air For 1, Adidas Forumm </p>
                            <p><strong> Ngày tạo đơn:</strong> 01/09/2003 23:35 </p>
                            <p><strong>Thông tin vận chuyển:</strong> SPX Express-SPXVN99092902</p>
                            
                        </div>
                        <div class="col-md-6">
                        <p class="text-center"><strong>Thông tin Khách hàng</strong></p>
                            <p><strong>Mã đơn hàng:</strong> PH30833</p>
                            <p><strong>Khách hàng:</strong> Nguyễn Văn Trường</p>
                            <p><strong>Điện thoại:</strong> 0333333333</p>
                            <p><strong>Địa chỉ:</strong> Nam Son - Nam Phuong Tien - Chuong My - Ha Noi</p>
                        </div>
                        
                    </div>
                </div>
                <div class="order-status" style="margin-top:30px;">
                        <p class="text-center "><strong>Trạng Thái Đơn Hàng</strong></p>
                        <ul class="step-indicator">
                            <li class="completed active" data-step="1">
                                <div class="step">&#10004;</div>
                                <div>Đặt hàng</div>
                                <div>01/09/2003 14:50</div>
                            </li>
                            <li class="completed active" data-step="2">
                                <div class="step">&#10004;</div>
                                <div>Duyệt</div>
                                <div>01/09/2003 14:50</div>
                            </li>
        ...
        <table class="product-table">
            ...
            <tbody>
                <tr>
                    ...
                    <td><img src="shoe1.jpg" alt="Giày Thể Thao Nam" class="shoe-image"></td>
                    <td>1.200.000 VNĐ</td>
                </tr>
                <tr>
                    <td>Giày Chạy Bộ</td>
                    <td><img src="shoe2.jpg" alt="Giày Chạy Bộ" class="shoe-image"></td>
                    <td>950.000 VNĐ</td>
                </tr>
                <tr>
                    <td>Giày Sneaker</td>
                    <td><img src="shoe3.jpg" alt="Giày Sneaker" class="shoe-image"></td>
                    <td>1.500.000 VNĐ</td>
                </tr>
            </tbody>
        </table>
    </div>
                    <div class="text-right "><button class="btn btn-danger mb-3">Mua Lại</button></div>
                    </div>
...
<script>
    ...
    $(document).ready(function() {
            $('.step-indicator li').click(function() {
                var step = $(this).data('step');
                $('.step-indicator li').removeClass('completed');
