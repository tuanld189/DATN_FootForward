...
<div class="product-content mt-5">
    <div class="container">
        <h2 class="text-center">Profile Personal</h2>
        @if(session('status'))
        ...
        <nav>
            <ul class="nav nav-tabs nav-tabs-custom nav-success" id="nav-tab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="nav-additional-tab" data-bs-toggle="tab" href="#nav-additional" role="tab" aria-controls="nav-additional" aria-selected="true">Personal Information</a>
                </li>
                <li class="nav-item">
                ...
                <div class="row">
                    <div class="col-md-4 text-center ">
                        <div class="profile-pic  text-center">
                            <img id="profileImage" src="{{ $user->photo_thumbs ? Storage::url($user->photo_thumbs) : asset('public/assets/images/banner/Avatardf.jpg')  }}" class="img-fluid rounded-circle  shadow" alt="Profile Picture">
