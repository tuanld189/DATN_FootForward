<style>
     .select-container {
        ...
        .select-container select:focus {
            border-color: #8a8f6a; /* Màu viền khi focus */
...
<div class="shop-wrapper-tab-panel ">
    <div class="shop-slider">
        <div class="shop-product-area">
            <div class="row" >
                <!-- Sắp xếp -->
                <div class="col-md-12 shadow-lg" style="display: flex; justify-content: flex-end;height: 60px;padding: 10px;width: 840px;margin-left: 10px; background-color: #8a8f6a4a;">
                <div class="col-md-3 " >
                    <form id="sortForm" method="GET" action="{{ route('shop') }}" >
                        <div class="select-container"  >
                            <select name="sort" id="sort" class="form-control" onchange="submitSortForm()" style="border-color: white;border-radius: 10px;">
                                <option  value="" {{ request('sort') == '' ? 'selected' : '' }}>Tất cả sản phẩm</option>
        ...
        <div class="single-product-wrap">
            ...
            <div class="product-content">
                ...
                <div class="product-action">
                    <button class="add-to-cart" title="Thêm vào giỏ hàng"><i class="fa fa-plus"></i> Thêm vào giỏ hàng</button>
...
<script>
 $(document).ready(function() {
            $('#sort').focus(function() {
                $('.select-container').addClass('select-focused');
            }).blur(function() {
                $('.select-container').removeClass('select-focused');
            });
        });
</script>
