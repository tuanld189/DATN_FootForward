                ...
                <div class="col-lg-3">
                    <div class="row">
                        ...
                        <div class="col-md-12 shadow-lg"
                            style="padding: 10px 0 0 15px;height: 60px;    background-color: #8a8f6a4a;">
                            <form id="searchForm" action="{{ route('shop') }}" method="GET"
                                ...
                                <div class="input-group">
                                    ...
                                    <button type="submit" class="btn btn-primary"
                                        style="border-radius: 0 10px 10px 0;border: 1px solid #8a8f6a;">Tìm kiếm</button>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="text-decoration-none" data-bs-toggle="collapse" href="#categoryMenu"
                            ...
                            style="width: 300px;height: 40px;background-color: #8a8f6a4a;padding: 10px 5px; margin-bottom: 5px;border-radius: 10px; margin-top: 35px;">
                                ...
                                @foreach ($categories as $category)
                                    <div class="checkbox-container">
                                        ...
                                        <label for="category_{{ $category->id }}"
                                            class="checkbox-label">{{ $category->name }}</label>
                                    </div>
                                @endforeach
                            </form>
                        </div>
                        ...
                        <!-- Brand Filter Form -->
                        <div class="text-decoration-none" data-bs-toggle="collapse" href="#brandMenu" role="button"
                        ...
                        <div class="text-decoration-none" data-bs-toggle="collapse" href="#priceMenu" role="button"
                            ...
                            style="width: 300px; height: 40px; background-color: #8a8f6a4a; padding: 10px 5px; margin-bottom: 5px; border-radius: 10px;">
                            <h5 style="font-weight: bold; color: #8a8f6a;">
                                <a class="text-decoration-none" href="#priceMenu" role="button" aria-expanded="false"
