                ...
                <div class="col-lg-4 col-md-6">
                     ...
                     <div class="footer-info-area">
                         ...
                         <div class="desc_footer">
                             ...
                             <p><i class="fa fa-envelope-open-o"></i> <span> wk@footforward.vn</span> </p>
...
<div class="footer-title">
                ...
                <div class="col-lg-4 col-md-12">
                     ...
                     <div class="footer-info-area">
                         <div class="footer-title">
                             <h3>Để lại thông tin để có thể nhận thông tin mới nhất về FootForward: </h3>
                         </div>
                         <div class="desc_footer">
             ...
             <div class="row">
                 <div class="col-lg-6 col-md-7">
                     <div class="copy-right">
                         <p>FootForward 2024 | <a href="#"> Cùng bạn có trải nghiệm tốt nhất tại cửa hàng</a>  </p>
                     </div>
                 </div>
